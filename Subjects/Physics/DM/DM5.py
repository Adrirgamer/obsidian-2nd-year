...
def derivee_u(u, t):
    ...
    """
    return 'à compléter'  # expression à compléter
...
def euler(F, y0, t0, tf, dt):
    ...
    """
  # Création et initialisation des variables de sortie : à compléter
    """
    t = np.arange(tmin,tmax,dt)
    Renvoie un tableau de points, espacés du pas dt, entre tmin (inclus) et tmax (exclus)
    """
    t = 'à compléter'         # les valeurs sont comprises dans l'intervalle [t0,tf+dt[ avec un pas égal à dt
    N = 'à compléter'         # Taille du tableau t
    y = 'à compléter'         # initialisation du tableau y
    y[0] = 'à compléter'      # prise en compte de la CI : à compléter
...
dt =  'à compléter'          # Expression du pas de résolution : à compléter
t, u_Euler =  'à compléter'  # résolution par la méthode d'Euler
...
"""
t_fixe = 'à compléter'       # Variable temporelle contenant 100 valeurs dans [t0,tf] : à compléter
...
plt.plot('à compléter', label = f"Solution exacte ")   # Graphe temporel de la solution exacte en trait rouge, le temps étant en ms : à compléter
plt.plot('à compléter', label = r"Solution numérique avec $\delta t = \dfrac{\tau}{10}$"+f" = {dt*1e3} ms") # Graphe temporel de la solution numérique en tirets bleus, le temps étant en ms : à compléter
...
# Graphe temporel de la solution exacte en trait rouge, le temps étant en ms : à compléter

# Boucle de résolutions numériques pour différents pas de résolution et tracé des solutions : à compléter

# Gestion de l'affichage : à compléter
