...
## Cellule 2 : Définition des constantes du problème : à compléter
n = 'à compléter'               # indice optique du verre de la lentille : à compléter
R = 'à compléter'               # rayon de la lentille (en cm) : à compléter

## A - Définition des fonctions utiles

## Cellule 3 : Fonctions "géométriques" : à compléter
...
yMax = 'à compléter'   # Valeur maximale de la largeur du faisceau incident, au-delà de laquelle
...
## Cellule 6 : Distances de focalisation : à compléter
...
def distFocalisation(yI):
    ...
    if abs(yI) > yMax:              # cas où il y a réflexion totale
        return None    
    ...
    return                          # Expression de xA' : à compléter
